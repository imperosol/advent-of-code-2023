...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `62.4µs` | `1.8ms` |
| [Day 2](./src/bin/02.rs) | `62.7µs` | `91.0µs` |
| [Day 3](./src/bin/03.rs) | `188.1µs` | `149.7µs` |
| [Day 4](./src/bin/04.rs) | `316.9µs` | `341.3µs` |
| [Day 5](./src/bin/05.rs) | `34.8µs` | `-` |
| [Day 6](./src/bin/06.rs) | `378.0ns` | `1.0µs` |
